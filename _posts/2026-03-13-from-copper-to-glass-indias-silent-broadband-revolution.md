...
1. **More 5G towers** → demand for more fiber
2. **More fiber** → cheaper per-km cost → better economics for FTTH
3. **Better FTTH** → faster home internet → more data consumption
4. **More data consumption** → demand for more 5G towers

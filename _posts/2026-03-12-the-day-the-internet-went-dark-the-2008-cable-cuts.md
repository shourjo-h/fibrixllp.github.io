...
1. **Locating the break** — using optical time-domain reflectometry (OTDR) to pinpoint the fault to within meters.
2. **Deploying a cable ship** — specialized vessels like the ones operated by SubCom or Alcatel Submarine Networks.
3. **Grappling the cable** from the seabed, which can be thousands of meters deep.
4. **Cutting and splicing** — the damaged section is cut out and a new segment is spliced in, a process that takes hours of precision work.
5. **Re-laying the cable** and burying it back into the seabed.
